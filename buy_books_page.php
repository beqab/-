...
<body>
	        ...
	        <div class="container_book">
		 	 <div class="block_book">
				...
				?>
		 	 	...
		 	 	<div class="book_info">
		 	 		<span><span class="book_price" id="ge1">10 </span> ლარი</span>
		 	 		<select>
		 	 			<option class="hidden_somthing" selected="selected">კლასი</option>
		 	 			<option>2 კლასი</option>
		 	 			<option>3 კლასი</option>
		 	 ...
		 	 <div class="block_book">
				...
				?>
		 	 	...
		 	 	<div class="book_info">
		 	 		<span><span class="book_price" id="ge2">12 </span> ლარი</span>
		 	 		<select>
		 	 			<option class="hidden_somthing" selected="selected">კლასი</option>
		 	 			<option>2 კლასი</option>
		 	 			<option>3 კლასი</option>
  ...
  <!-- 	 <div class="product">
   ...
   <input type="text" name="addres" placeholder="მშობლის სახელი" id="parent_firstname">
   <input type="text" name="addres" placeholder="მშობლის გვარი" id="parent_lastname">
...
<script type="text/javascript">
  ...
  function warmatebiTgaigzavna(){
		...
		if($("#parent_firstname").val()==""){alert("გთხოვთ მიუთითოთ მშობლის სახელი");return;}
		if($("#parent_lastname").val()==""){alert("გთხოვთ მიუთითოთ მშობლის გვარი");return;}


		if(ordered_book.length==0){alert("თქვენ არ აგირჩევიათ არცერთი წიგნი");return;}

  		$.post('buy_books.php', {town: $("#town").val(),address: $("#address").val(),contact_number: $("#contact_number").val(), additional_info: $("#additional_info").val(), books: JSON.stringify(ordered_book),parent_name: $("#parent_firstname").val(),parent_lastname: $("#parent_lastname").val(),}, function(data){
  			if(data=="Success"){
  				setTimeout(function(){ 
